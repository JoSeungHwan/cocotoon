...
//    @IBOutlet var containerView: UIView!
    ...
    let cookie_domain = "https://cocotoon.co.kr/m"
...
//        webView.scrollView.showsHorizontalScrollIndicator = t // 세로 스크롤 막기
//        webView.scrollView.showsVerticalScrollIndicator = false // 가로 스크롤 막기
//        webView.scrollView.alwaysBounceVertical = false
//        webView.scrollView.alwaysBounceHorizontal = false
//        webView.scrollView.bounces = false

        if let url = URL(string: "http://cocotoon.co.kr/m/"){
